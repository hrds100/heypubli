export default function ThankYouPage() {
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white flex flex-col">
      {/* Success Bar */}
      <div className="bg-[#10B981] text-white text-center py-3 px-4">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="max-w-lg w-full text-center">
          ...
          <p className="text-gray-400 text-lg mb-10">
            Seu acesso ao ScanPlates está pronto. Siga os passos abaixo para começar a
            usar agora mesmo.
          </p>

          {/* Steps */}
          <div className="bg-[#1a1a1a] border border-gray-800 rounded-2xl p-6 md:p-8 text-left mb-8">
            <h2 className="text-lg font-bold mb-5 text-center">
              Como acessar o ScanPlates:
            </h2>
            <div className="space-y-5">
              <div className="flex gap-4">
                <div className="w-8 h-8 bg-[#10B981] rounded-full flex items-center justify-center shrink-0 text-sm font-bold">
                  1
                </div>
                <div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            <a
              ...
              className="flex items-center gap-3 bg-white text-black px-6 py-3 rounded-xl hover:bg-gray-100 transition w-full sm:w-auto justify-center"
            >
              <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
              </svg>
              <div className="text-left">
                <p className="text-[10px] leading-none">Baixar na</p>
            ...
            >
              ...
              <div className="text-left">
                <p className="text-[10px] leading-none">Disponível no</p>
          ...
          <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl p-4">
            <p className="text-gray-400 text-sm">
              ...
              <a
                href="mailto:suporte@scanplates.com"
                className="text-[#10B981] underline"
              >
                suporte@scanplates.com
              </a>
            </p>
          </div>
