...
const TIERS = [
  ...
  },
  {
    ...
    products: [
      ...
      { alt: "JBL", logo: "/brands/jbl.svg" },
      { alt: "Bose", logo: "/brands/bose.svg" },
    ],
  },
  {
    name: "VIP",
    ...
    products: [
      ...
      { alt: "New Balance", logo: "/brands/newbalance.svg" },
      { alt: "Under Armour", logo: "/brands/underarmour.svg" },
      { alt: "Reebok", logo: "/brands/reebok.svg" },
      { alt: "Fila", logo: "/brands/fila.svg" },
    ],
  },
];
